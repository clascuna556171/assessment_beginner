...
<div class="container">
  <div class="page-header">
    ...
    <p>View available tools and assign them to bookings</p>
  </div>

<?php if($message): ?>
  <div class="alert tools-message"><?php echo $message; ?></div>
<?php endif; ?>
...
<h3 class="section-title" style="margin-top: 24px;">Assign Tool to Booking</h3>
